...
Use this skill to search Robot Framework libraries/resources/suites for keywords
that match a use case. Output JSON only.
...
https://github.com/manykarim/robotframework-agentskills/tree/main/skills/robotframework-libdoc-search.)
